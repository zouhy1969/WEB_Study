<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chatsend.aspx.cs" Inherits="chatsend" %>
...
<form id="form1" runat="server">
    <div>
        ...
        <asp:Button ID="Btnsend" runat="server" Text="发送" OnClick="Btnsend_Click" /><br />
        &nbsp;<br />
        颜色:&nbsp;
        ...
        &nbsp;<br />
        <asp:Button ID="Button1" runat="server" Text="清空聊天室" OnClick="Button1_Click" />&nbsp; 
        <asp:Button ID="Button2" runat="server" Text="离开聊天室" OnClick="Button2_Click" />
        <br />
        </div>
    </form>
</body>
