...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Caption="上传文件一览表"
            CellPadding="4" DataKeyNames="id" DataSourceID="AccessDataSource1" ForeColor="#333333" PageSize="5" AllowPaging="True">
            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            <Columns>
                <asp:CommandField ShowDeleteButton="True" ButtonType="Button" HeaderText="操作" />
